...
// CODE HERE
// uniq(names, newArr = (uniqArr) => console.log(`The new name array with all the duplicate items removed is ${uniqArr}`))
...
// CODE HERE
// each(names, cb = (item, index) => console.log(`The item at index ${index} is ${item}.`))
